...
def test_water_column_height():
    ...
    assert water_column_height(0.0,10) == approx(7.5)
...
def test_pressure_loss_from_pipe():
    assert pressure_loss_from_pipe(0.048692, 000.00, 0.018, 1.75,) == approx( 000.000, abs=0.001)
    assert pressure_loss_from_pipe(0.048692,0200.00, 0.000, 1.75,) == approx( 000.000, abs=0.001)
    assert pressure_loss_from_pipe(0.048692,0200.00, 0.018, 0.00,) == approx( 000.000, abs=0.001)
    assert pressure_loss_from_pipe(0.048692,0200.00, 0.018, 1.75,) == approx(-113.008, abs=0.001)
    assert pressure_loss_from_pipe(0.048692,0200.00, 0.018, 1.65,) == approx(-100.462, abs=0.001)
    assert pressure_loss_from_pipe(0.286870,1000.00, 0.013, 1.65,) == approx(-061.576, abs=0.001)
    assert pressure_loss_from_pipe(0.286870,1800.75, 0.013, 1.65,) == approx(-110.884, abs=0.001)


def test_pressure_loss_from_fittings():
    assert pressure_loss_from_fittings(0.00,3) == approx(00.000, abs=0.001)
    assert pressure_loss_from_fittings(1.65,0) == approx(00.000, abs=0.001)
...
def test_reynolds_number():
    assert reynolds_number(0.048692, 0.00) == approx(000000,abs=1)
...
def test_pressure_loss_from_pipe_reduction():
    assert pressure_loss_from_pipe_reduction(0.28687, 0.00, 1, 0.048692) == approx( 000.000,abs=0.001)
